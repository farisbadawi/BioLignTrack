// app/(patient)/progress.tsx - COMPLETE FILE WITH REAL DATA
...
export default function ProgressScreen() {
  const { patient, dailyLogs, trayChanges, assignedDoctor, userType, currentSession, todayWearSeconds, getComplianceStats, hasTreatment } = usePatientStore();
  ...
  // Parse YYYY-MM-DD as local date (not UTC — new Date("2026-03-09") parses as UTC!)
  ...
  const calculateStats = () => {
    ...
    const firstLogDateObj = parseLocalDate(firstLogDate);
    ...
    const monthStartDate = parseLocalDate(monthStart);
            ...
            {userType === 'linked' && !hasTreatment ? (
              <>
                ...
                <Text style={[styles.notStartedText, { color: colors.textSecondary }]}>
                  Your doctor hasn't set up your treatment yet. Progress tracking will be available once your treatment plan is active.
                </Text>
              </>
            ) : (
              <>
